...
{\scriptsize
	\begin{algorithmic}[1]
        ...
        \REPEAT
        \STATE{$\langle \hat{\epsilon}, \hat{\mathcal{G}} \rangle$ $\leftarrow$ \texttt{GenObf}(...,$\sigma_{u}$)} \\
        ...
        \REPEAT
            ...
            \STATE {$\langle \hat{\epsilon}, \hat{\mathcal{G}} \rangle \leftarrow \texttt{GenObf}(..., \sigma_{mid})$}
