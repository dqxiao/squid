...
%
\title{Uncertain Graphs Sharing Using Synthetic Private Graph Models}
...
To overcome such limitation, our work seeks a solution to release \emph{uncertain graphs} with high utility while preserving privacy. We show that simply combining conventional graph anonymization with representative extraction strategy results in the addition of noise that significantly disrupt \emph{uncertain graph} structure, degrading its utility. Instead, we introduce an uncertainty-aware XXXX
\end{abstract}
